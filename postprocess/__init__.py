...
- ``union_488_560`` -- the IoMin-stitched union of the 488 and 560 indexed
  masks produced by ``postprocess/union_488_560_mask.py``.
...
``union_488_560`` the on-disk name is ``union_488_560_otsu_shape.tif``; filtered
crops live under ``cell_box_otsu_shape_filtered/`` (and full-Z under
...
VARIANT_FILES: dict[str, dict[str, str]] = {
    ...
    "union_488_560": {
        ...
        "pass_otsu_shape": "union_488_560_otsu_shape.tif",
