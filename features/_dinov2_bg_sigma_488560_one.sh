#!/usr/bin/env bash
# GPU per-sample worker: DINOv2 from cell_box_bg_sigma_488560_shape crops.
# Usage (called by submit_dinov2_bg_sigma_488560_batch.sh via bsub):
#   bash features/_dinov2_bg_sigma_488560_one.sh <SAMPLE_DIR>
#
# Requires:
#   <SAMPLE_DIR>/cell_box_bg_sigma_488560_shape/
#   <SAMPLE_DIR>/dinov2_volume_norm_bounds_union_488_560.csv
#
# Output: <SAMPLE_DIR>/cell_qc_bg_sigma_488560_shape/dinov2_embeddings.{npy,csv}
...
CELL_BOXING_DIR="cell_box_bg_sigma_488560_shape"
CELL_QC_DIR="cell_qc_bg_sigma_488560_shape"
